...
const char* ssid = "OppoA15"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "77777777"; // Your Wifi password, in case you have open network comment the whole statement.
